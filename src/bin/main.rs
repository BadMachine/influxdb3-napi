...
async fn main(){
    ...
    let mut response = client.query_batch(String::from("_internal"), String::from("SELECT * from system.queries WHERE query_text IS NOT NULL LIMIT 1000000000"), QueryType::Sql).await .unwrap();
